...
public class FrameBuilderRunnableTest {
    ...
    @Test
    public void testFramesBuilderTerminatesCorrectly() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        FramesBuilderRunnable framesBuilderRunnable = new FramesBuilderRunnable(0, null,
                readBuffers, packetsQueue, terminatedSignal);
    ...
    public void testQueueWithSingleBufferAndMultiplePackets() throws InterruptedException {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(packet1.byteSize() + packet2.byteSize() + packet3.byteSize());
        ...
        FramesBuilderRunnable framesBuilderRunnable = new FramesBuilderRunnable(0, new StandardPacketsBuilder(1024),
                readBuffers, packetsQueue, terminatedSignal);
