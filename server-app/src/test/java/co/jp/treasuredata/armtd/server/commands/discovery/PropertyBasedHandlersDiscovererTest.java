...
public class PropertyBasedHandlersDiscovererTest {
  ...
  public void mustIgnoreAllIrrelevantLines() throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(null, onlyIrrelevantLinesConfig);
  ...
  public void mustThrowExceptionWhenClassNameIsUnavailableOnClasspath() throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(null, missingClassNameConfig);

    discoverer.resolveHandlers();
  }

  @Test(expected = DiscovererException.class)
  public void mustThrowExceptionWhenClassNameIsNotAnInstanceOfRouteHandler()
      throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(
            null,
            isNotAnInstanceOfRouteHandler,
            PropertyBasedHandlersDiscovererTest.class.getClassLoader());

    discoverer.resolveHandlers();
  }

  @Test(expected = DiscovererException.class)
  public void mustThrowExceptionWhenClassNameIsMissingRequiredAnnotation()
      throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(
            null,
  ...
  @Test(expected = DiscovererException.class)
  public void mustThrowExceptionWhenClassNameIsMissingCompatibleConstructor()
      throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(
            null,
            missingCompatibleConstructor,
            PropertyBasedHandlersDiscovererTest.class.getClassLoader());
  ...
  @Test
  public void mustBeAbleToIdentifyCorrectRouteHandlerInstancesNotRequiringConfig()
      throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(
            null,
            correctDummyHandlerWithoutConfig,
            PropertyBasedHandlersDiscovererTest.class.getClassLoader());
  ...
  @Test
  public void mustBeAbleToIdentifyCorrectRouteHandlerInstancesWithDefaultConstructor()
      throws DiscovererException {
    PropertiesBasedHandlersDiscoverer discoverer =
        new PropertiesBasedHandlersDiscoverer(
            null,
            correctDummyHandlerWithDefaultConstructor,
            PropertyBasedHandlersDiscovererTest.class.getClassLoader());

    List<RouteHandlerMapping> handlers = discoverer.resolveHandlers();
    assertEquals(1, handlers.size());
    assertEquals(
        CorrectDummyHandlerWithDefaultConstructor.class, handlers.get(0).getHandler().getClass());
    assertEquals(1, handlers.get(0).getMappings().size());
  }
  ...
  private static final Properties correctDummyHandlerWithoutConfig =
      createProperties(
  ...
  private static final Properties correctDummyHandlerWithDefaultConstructor =
      createProperties(
  ...
  private static final Properties correctDummyHandler =
      createProperties(
  ...
  private static final Properties missingRequiredAnnotation =
      createProperties(
  ...
  private static final Properties isNotAnInstanceOfRouteHandler =
      createProperties(
  ...
  private static final Properties missingCompatibleConstructor =
      createProperties(
  ...
  private static final Properties missingClassNameConfig =
      createProperties("route.className = x.y.Z");
  private static final Properties onlyIrrelevantLinesConfig =
      createProperties("x.x = ss\n\r" + "y.x = ss\n\r");
}
