...
public class FileResponseActionTest {
  ...
  @Test
  public void testFileResponseActionFetchingCorrectFile()
      throws IOException, InterruptedException, ExecutionException {
    File temporaryFile = File.createTempFile("test", "test");
    temporaryFile.createNewFile();

    BufferedWriter temporaryFileWriter =
        new BufferedWriter(new OutputStreamWriter(new FileOutputStream(temporaryFile)));
